...
namespace vmmsharp
{
    ...
    /// <summary>
    /// Scatter Read Result.
    /// Modified by Frost to use .NET Core Span/Memory architecture.
    /// </summary>
    public struct MEM_SCATTER
    {
        ...
        public ulong qwA;
        /// <summary>
        /// Page Read Result (0x1000 length).
        /// </summary>
    ...
    public static class vmm
    {
        ...
        /// <summary>
        /// Initializes local 'DMA Hardware'.
        /// </summary>
        /// <param name="args">Initialization arguments (see vmmdll.h for more info).</param>
        ...
        /// <summary>
        /// Uninitializes local 'DMA Hardware'.
        /// </summary>
        /// <returns>True if successful, otherwise False.</returns>
        ...
        /// <summary>
        /// Execute a 'Scatter Read' using array of provided Page Virtual Addresses.
        /// Modified by Frost to use .NET Core Span/Memory architecture.
        /// </summary>
        /// <param name="pid">Remote Process ID.</param>
        /// <param name="flags">'vmm.FLAG' flag(s).</param>
        /// <param name="qwA">Array of 'Pages' to scatter read (Virtual Addresses).</param>
        /// <returns>Array of 'MEM_SCATTER' structs.</returns>
        public static unsafe MEM_SCATTER[] MemReadScatter(uint pid, uint flags, params ulong[] qwA)
        {
            ...
            for (i = 0; i < MEMs.Length; i++)
            {
                ...
                byte[] buf = new byte[0x1000];
                Marshal.Copy(n.pb, buf, 0, 0x1000);
                MEMs[i].pb = buf.AsMemory(); // Use Memory<byte> instead of byte[] (still heap allocated)
            }
            lci.LcMemFree(pppMEMs);
            return MEMs;
        }
        ...
        /// <param name="cb">Read Length (bytes).</param>
        /// <param name="flags">'vmm.FLAG' flag(s).</param>
        /// <returns>Span byte buffer.</returns>
        ...
        /// <summary>
        /// Obtains 'Process ID' (PID) from a process (by name) running on the remote system.
        /// </summary>
        /// <param name="szProcName">Name of the process (including .exe).</param>
        /// <param name="pdwPID">(OUT) Process ID Result.</param>
        /// <returns>True if successful, otherwise False.</returns>
        ...
        /// <summary>
        /// Gets the 'Module Base Entry' virtual address from a specified Process & Module Name.
        /// </summary>
        /// <param name="pid">Remote Process ID.</param>
        /// <param name="wszModuleName">Name of the module (including .exe/.dll).</param>
        /// <returns>Virtual address of the module.</returns>
        ...
        /// <summary>
        /// Obtains a 'Map' of Physical Memory on the Remote System.
        /// </summary>
        /// <returns>Array of 'MAP_PHYSMEMENTRY' structs.</returns>
